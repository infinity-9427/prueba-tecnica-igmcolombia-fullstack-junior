...
return [
    ...
    */
    ...
    /*
     * Dejavu Sans font is missing glyphs for converted entities, turn it off if you need to show €, £, etc.
     */
    ...
    'options' => [
         ...
         * This setting is not supported in the [CSS @import] functionality.
         */
         ...
         *
         * Recommended, but may be slow on large documents
         *
         * @var bool
         */
