          ...
          <div class="flex items-center space-x-4">
            ...
            <div v-if="isAuthenticated" class="relative">
              ...
              >
                ...
                <Icon icon="mdi:chevron-down" class="hidden sm:block h-4 w-4 text-gray-500 transition-transform duration-200" 
...
const handleClickOutside = (event: Event) => {
  ...
  const userMenuButton = document.querySelector('button[aria-expanded]') || document.querySelector('.relative button')
  const userMenuDropdown = document.querySelector('.relative > div[class*="absolute"]')
  
  // If click is outside both button and dropdown, close menu
