...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g2 = m2[u], f2 = ve(g2), p3 = z(u, a2) ? Q2(d) : Q2(d, ee(u));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return { primitive: { css: l, tokens: o }, semantic: { css: c, tokens: m2 }, global: { css: d, tokens: u }, style: g2 };
}, getPreset({ name: e = "", preset: t2 = {}, options: r, params: s4, set: i2, defaults: a2, selector: n }) {
  var f2, x3, p3;
  let l, o, c;
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te } = g2, re = v2(g2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y2]: h2(h2({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h2(h2({}, L), re) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te) }, r) : {}, [G3, U3] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l, o = {}, c = []) {
    ...
    Object.entries(l).forEach(([m2, d]) => {
      let u = z(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g2 = c ? `${c}.${m2}` : m2;
      i(d) ? n(d, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x3 = {}, p3 = []) => {
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l, d, t2)), m2), "") : C2(l != null ? l : ":root,:host", t2);
    }
    if (o) {
...
// node_modules/.pnpm/@primevue+core@4.3.9_vue@3.5.22_typescript@5.9.3_/node_modules/@primevue/core/usestyle/index.mjs
function _typeof(o) {
...
// node_modules/.pnpm/@primevue+core@4.3.9_vue@3.5.22_typescript@5.9.3_/node_modules/@primevue/core/base/style/index.mjs
function _typeof2(o) {
  "@babel/helpers - typeof";
...
//# sourceMappingURL=chunk-NK6YYDTR.js.map
